...
class Address(models.Model):
    ...
    address = models.CharField(max_length=255, null=True, blank=True, default='', verbose_name='Address',
                               help_text='Address')
    ...
    zip_code = models.CharField(max_length=255, null=True, blank=True, default='', verbose_name='Zip Code',
                                help_text='Zip Code')
...
class Category(models.Model):
    ...
    description = models.TextField(null=True, blank=True, default='', verbose_name='Description',
...
class Cart(models.Model):
    status = models.CharField(choices=CART_STATUS, max_length=255, default='active', verbose_name='Status',
                              help_text='Status')
...
class Order(models.Model):
    ...
    products = models.ManyToManyField(Product, related_name='orders', verbose_name='Product', help_text='Product')
    price = models.DecimalField(decimal_places=2, max_digits=10, default=0, verbose_name='Price', help_text='Price')
    quantity = models.IntegerField(default=1, verbose_name='Quantity', help_text='Quantity')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Created At', help_text='Created At')
    updated_at = models.DateTimeField(auto_now=True, verbose_name='Updated At', help_text='Updated At')
